...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference("Vendor.count") do
      post vendors_url, params: { vendor: { name: @vendor.name, vendor_id: @vendor.vendor_id } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { name: @vendor.name, vendor_id: @vendor.vendor_id } }
